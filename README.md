About neptune-client-feedstock
==============================
...
Once the `conda-forge` channel has been enabled, `neptune-client` can be installed with `conda`:
...
```
mamba install neptune-client
```

It is possible to list all of the versions of `neptune-client` available on your platform with `conda`:
...
```
mamba search neptune-client --channel conda-forge
```
...
mamba repoquery search neptune-client --channel conda-forge

# List packages depending on `neptune-client`:
mamba repoquery whoneeds neptune-client --channel conda-forge

# List dependencies of `neptune-client`:
mamba repoquery depends neptune-client --channel conda-forge
```
